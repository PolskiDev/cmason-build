...
\section{Run CMason - Masonfile}
\begin{verbatim}
	
SYNTAX:
mason-common -t <target>
mason-save -t <target>
mason-dev -t <target>
...
CMason Common binary inspects Masonfile archives looking for targets based on: Current running Operating System and CPU Architecture
