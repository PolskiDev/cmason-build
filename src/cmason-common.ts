...
export function CommonMakeCompileFunction() {
    for(var token in t) {
        t.push(token);
    ...
    */
    ...
    for (var i=0; i < t.length; i++) {
        ...
        if(os.windows) {
            if (os.i386) {
                if (t[i] == lex.winI32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.winI32_target+"_"+main_target)
            ...
            if (os.amd64) {
                if (t[i] == lex.winI64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.winI64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm64) {
                if (t[i] == lex.winArm64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.winArm64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm32) {
                if (t[i] == lex.winArm32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.winArm32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.i386) {
                if (t[i] == lex.linux32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linux32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.amd64) {
                if (t[i] == lex.linux64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linux64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm32) {
                if (t[i] == lex.linuxArm32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linuxArm32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm64) {
                if (t[i] == lex.linuxArm64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linuxArm64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.powerpc32) {
                if (t[i] == lex.linuxPPC32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linuxPPC32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.powerpc64) {
                if (t[i] == lex.linuxPPC64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linuxPPC64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.s390) {
                if (t[i] == lex.linuxS390_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linuxS390_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.s390x) {
                if (t[i] == lex.linuxS390x_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linuxS390x_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.mips) {
                if (t[i] == lex.linuxMIPS_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linuxMIPS_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.mipsel) {
                if (t[i] == lex.linuxMIPSel_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.linuxMIPSel_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.i386) {
                if (t[i] == lex.darwin32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.darwin32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.amd64) {
                if (t[i] == lex.darwin64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.darwin64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm64) {
                if (t[i] == lex.darwinAppleSilicon_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.darwinAppleSilicon_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.i386) {
                if (t[i] == lex.freebsd32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsd32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.amd64) {
                if (t[i] == lex.freebsd64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsd64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm32) {
                if (t[i] == lex.freebsdArm32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsdArm32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm64) {
                if (t[i] == lex.freebsdArm64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsdArm64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.powerpc32) {
                if (t[i] == lex.freebsdPPC32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsdPPC32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.powerpc64) {
                if (t[i] == lex.freebsdPPC64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsdPPC64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.s390) {
                if (t[i] == lex.freebsdS390_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsdS390_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.s390x) {
                if (t[i] == lex.freebsdS390x_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsdS390x_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.mips) {
                if (t[i] == lex.freebsdMIPS_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsdMIPS_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.mipsel) {
                if (t[i] == lex.freebsdMIPSel_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.freebsdMIPSel_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.i386) {
                if (t[i] == lex.openbsd32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsd32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.amd64) {
                if (t[i] == lex.openbsd64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsd64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm32) {
                if (t[i] == lex.openbsdArm32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsdArm32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm64) {
                if (t[i] == lex.openbsdArm64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsdArm64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.powerpc32) {
                if (t[i] == lex.openbsdPPC32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsdPPC32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.powerpc64) {
                if (t[i] == lex.openbsdPPC64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsdPPC64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.s390) {
                if (t[i] == lex.openbsdS390_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsdS390_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.s390x) {
                if (t[i] == lex.openbsdS390x_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsdS390x_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.mips) {
                if (t[i] == lex.openbsdMIPS_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsdMIPS_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.mipsel) {
                if (t[i] == lex.openbsdMIPSel_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.openbsdMIPSel_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.i386) {
                if (t[i] == lex.sunos32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunos32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.amd64) {
                if (t[i] == lex.sunos64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunos64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm32) {
                if (t[i] == lex.sunosArm32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunosArm32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.arm64) {
                if (t[i] == lex.sunosArm64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunosArm64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.powerpc32) {
                if (t[i] == lex.sunosPPC32_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunosPPC32_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.powerpc64) {
                if (t[i] == lex.sunosPPC64_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunosPPC64_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.s390) {
                if (t[i] == lex.sunosS390_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunosS390_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.s390x) {
                if (t[i] == lex.sunosS390x_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunosS390x_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.mips) {
                if (t[i] == lex.sunosMIPS_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunosMIPS_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
            ...
            if (os.mipsel) {
                if (t[i] == lex.sunosMIPSel_target+"_"+main_target && t[i+1] == lex.separator) {
                    let cmd = t[i+2].slice(1,-1)
                    console.log("\n\n\x1b[32mSelected target: "+lex.sunosMIPSel_target+"_"+main_target)
                    console.log("\x1b[32mTarget command: "+cmd)
                    exec(cmd, (error, stdout, stderr) => {
                        if (error) {
                            console.log(`error: ${error.message}`);
